...
def run_python():
    """Runs the Python language tests."""
    ...
    num_execucoes = 50
    script_path = os.path.join(base_dir, 'codigo', 'python', 'busca_py.py')
    ...
    try:
        with open(path_resultados, 'w') as f_out:
            ...
            for n in tamanhos:
                ...
                for i in range(1, num_execucoes + 1):
                    ...
                    cmd_completo = f"{sys.executable} {script_path} \"{arquivo_csv}\""
        ...
        print(f"--- Testes para Python concluídos. Resultados salvos em {path_resultados} ---")
